...
export default function PipelineDetailsPage() {
  ...
  for(let i=0;i<pipeline.activities.length;i++){
    total_duration +=pipeline.activities[i].durationInMs
  }
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl font-bold mt-1">
                    {primaryActivity ? formatDuration(total_duration) : "N/A"}
                  </h3>
                </div>
                ...
                <CardContent className="pt-6 bg-white">
                  <div className="relative pl-8 border-l-2 border-blue-300 space-y-10">
                    <div className="relative">
                      ...
                      <div>
                        <p className="font-medium text-blue-800 text-lg ml-2">Pipeline Started</p>
